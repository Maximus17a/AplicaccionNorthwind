// Este archivo contiene funciones auxiliares para la exportación a PDF
// Dependencias: iText.js o PDFMake.js (ya se manejan en el servidor en este caso)

// Función para permitir la descarga de archivos PDF
